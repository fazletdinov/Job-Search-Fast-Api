"""create table user, vacansy, resume, comment

Revision ID: 0a4e52a718c3
Revises: 
Create Date: 2023-10-24 20:10:00.519642
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['vacansy_id'], ['vacansy.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
